    ...
    <main className="min-h-screen p-6 sm:p-8">
      <div className="mx-auto flex w-full max-w-6xl flex-col gap-8">
        <HeroSection className="p-6 sm:p-8">
          <div className="pointer-events-none absolute -left-20 top-0 h-48 w-48 rounded-full bg-[radial-gradient(circle,rgba(210,167,75,0.28),transparent_70%)]" />
          ...
          <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
            <div>
              <p className="text-[11px] font-semibold uppercase tracking-[0.34em] text-[rgba(210,167,75,0.92)]">
                {eyebrow}
              </p>
